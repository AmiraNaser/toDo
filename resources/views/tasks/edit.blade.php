    ...
    <div class="container">
        ...
        <form action="{{ url('Task/'.$data->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" required id="exampleInputSDate" name="sDate" placeholder="" value="{{ old('sDate') }}">
            </div>
            <div class="form-group">
                <label for="exampleInputEDate">End Date</label>
                <input type="date" class="form-control" required id="exampleInputEDate" name="eDate" placeholder="" value="{{ old('eDate') }}">
            </div>
            ...
            <p>
                ...
                <img src="{{ url('/taskImages/' . $data->image) }}" alt="" width="200" height="200">
