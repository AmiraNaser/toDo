...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>Display Tasks</h1>      {{  "Welcome , ".auth()->user()->name  }}
            <br>
        ...
        <a href="{{url('/Task/create')}}">Add Task</a>   ||  <a href="{{url('/User/LogOut')}}">+ LogOut</a>
        ...
        @foreach ($data as $value )
            ...
            <tr>
               ...
               <td> <a href='{{url('/Task/'.$value->id)}}' class='btn btn-primary m-r-1em'>Show</a></td>
               <td>{{ $value->sDate}}</td>
               <td>{{ $value->eDate}}</td>
                ...
                <div class="modal-dialog" role="document">
                  ...
                  <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                         Are you sure you want to  Remove   {{$value->title}} ?
                        </div>
